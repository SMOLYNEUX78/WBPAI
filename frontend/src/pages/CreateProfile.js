    ...
    <div className="min-h-screen bg-gray-100 flex flex-col items-center p-6">
      <div className="w-full max-w-3xl bg-white p-6 shadow-lg rounded-xl">
        ...
        {profile.connectionMethod === "auto" && (
          <div>
            <button onClick={scanForSmartMeter} className="mt-4 bg-green-500 text-white px-4 py-2 rounded">
              Scan for Smart Meter
            </button>
            <button onClick={scanForSensors} className="mt-4 bg-blue-500 text-white px-4 py-2 rounded ml-2">
              Scan for Sensors
            </button>
          </div>
        )}
        ...
        <button onClick={handlePerformanceProfile} className="mt-6 bg-blue-600 text-white px-6 py-3 rounded">
          Create Profile
        </button>
      </div>
    </div>
